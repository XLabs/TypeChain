...
You will also need to install a desired target for example `@xlabs-xyz/typechain-ethers-v6`. [Learn more about targets](#targets-)
...
| [`@xlabs-xyz/typechain-ethers-v6`](/packages/target-ethers-v6)                                                                                        | [![npm](https://img.shields.io/npm/v/@xlabs-xyz/typechain-ethers-v6.svg)](https://www.npmjs.com/package/@xlabs-xyz/typechain-ethers-v6)   | Ethers ver 6 support (⚠️ requires TS 4.0 >=) | [example](./examples/ethers-v6)                                                                                      |
